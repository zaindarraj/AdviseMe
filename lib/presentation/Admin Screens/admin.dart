            ...
            children: [
              SizedBox(
                  ...
                  child: index < savedCategories.length - num
                      ? Image.network(url + savedCategories[index].image)
                      : Image.file(File.fromUri(
                          Uri.parse(savedCategories[index].image)))),
              Text(
                savedCategories[index].name,
                maxLines: 2,
                overflow: TextOverflow.ellipsis,
                style:
                    GoogleFonts.arvo(fontSize: 18, fontWeight: FontWeight.bold),
              ),
            ],
          )),
    ),
              ...
              SizedBox(
                ...
                child: ClipOval(
                    child: (savedCons[index]["imageURL"] is String
                        ? Image.network(
                            url + savedCons[index]["imageURL"].toString(),
                            fit: BoxFit.cover,
                          )
                        : Image.asset(
                            "assets/default.jpg",
